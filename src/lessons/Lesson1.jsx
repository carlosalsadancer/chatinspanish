...
const SECTIONS = [
  {
    ...
    words: [
      { es: "el internet",          display: "internet",          pron: "el een-ter-NET",                     en: "internet",          phrase: { es: "¿Hay internet gratis en el aeropuerto?",        pron: "hay een-ter-NET GRAH-tees en el ah-eh-roh-PWER-toh",          en: "Is there free internet at the airport?" } },
      { es: "la migración",         display: "migración",         pron: "lah mee-grah-SYON",                 en: "immigration",        phrase: { es: "¿Dónde está la zona de migración?",             pron: "DON-deh es-TAH lah SO-nah deh mee-grah-SYON",                en: "Where is the immigration area?" } },
      { es: "la fila",              display: "fila",              pron: "lah FEE-lah",                       en: "line / queue",       phrase: { es: "Perdón, ¿esta es la fila para extranjeros?",    pron: "pehr-DON ES-tah ehs lah FEE-lah PAH-rah eks-tran-HEH-ros",  en: "Excuse me, is this the line for foreigners?" } },
      { es: "el pasaporte",         display: "pasaporte",         pron: "el pah-sah-POR-teh",                en: "passport",           phrase: { es: "Hola, aquí está mi pasaporte.",                 pron: "OH-lah ah-KEE es-TAH mee pah-sah-POR-teh",                   en: "Hello, here is my passport." } },
      { es: "el boleto de regreso", display: "boleto",            pron: "el boh-LEH-toh deh reh-GREH-soh",   en: "return ticket",      phrase: { es: "Tengo mi boleto de regreso aquí.",               pron: "TEN-goh mee boh-LEH-toh deh reh-GREH-soh ah-KEE",            en: "I have my return ticket here." } },
      { es: "la maleta",            display: "maleta",            pron: "lah mah-LEH-tah",                   en: "suitcase",           phrase: { es: "¿Dónde recojo mi maleta?",                      pron: "DON-deh reh-KOH-hoh mee mah-LEH-tah",                        en: "Where do I pick up my suitcase?" } },
      { es: "la salida",            display: "salida",            pron: "lah sah-LEE-dah",                   en: "exit",               phrase: { es: "¿Por dónde es la salida?",                      pron: "por DON-deh ehs lah sah-LEE-dah",                            en: "Which way is the exit?" } },
      { es: "el autobús ADO",       display: "autobús",           pron: "el ow-toh-BOOS ah-deh-OH",          en: "ADO bus",            phrase: { es: "¿Dónde compro el boleto de autobús ADO?",       pron: "DON-deh KOM-proh el boh-LEH-toh deh ow-toh-BOOS ah-deh-OH", en: "Where do I buy the ADO bus ticket?" } },
    ],
  },
  {
    ...
    words: [
      { es: "los pesos",         display: "pesos",          pron: "los PEH-sos",              en: "pesos",           phrase: { es: "¿Dónde puedo conseguir pesos?",               pron: "DON-deh PWEH-doh kon-seh-GHEER PEH-sos",             en: "Where can I get pesos?" } },
      { es: "la casa de cambio", display: "casa de cambio", pron: "lah KAH-sah deh KAM-byoh", en: "exchange office",  phrase: { es: "¿Dónde está la casa de cambio más cercana?",  pron: "DON-deh es-TAH lah KAH-sah deh KAM-byoh mas ser-KAH-nah", en: "Where is the nearest exchange office?" } },
      { es: "el cajero",         display: "cajero",         pron: "el kah-HEH-roh",           en: "ATM",             phrase: { es: "¿Hay un cajero cerca?",                       pron: "hay oon kah-HEH-roh SER-kah",                        en: "Is there an ATM nearby?" } },
      ...
      { es: "la cuenta",         display: "cuenta",         pron: "lah KWEN-tah",             en: "the bill",        phrase: { es: "¿Me puede traer la cuenta, por favor?",       pron: "meh PWEH-deh trah-EHR lah KWEN-tah por fah-VOR",    en: "Can you bring me the bill, please?" } },
      { es: "el efectivo",       display: "efectivo",       pron: "el eh-fek-TEE-boh",        en: "cash",            phrase: { es: "¿Solo aceptan efectivo?",                     pron: "SO-loh ah-SEP-tan eh-fek-TEE-boh",                   en: "Do you only accept cash?" } },
      { es: "la tarjeta",        display: "tarjeta",        pron: "lah tar-HEH-tah",          en: "card",            phrase: { es: "¿Aceptan tarjeta?",                           pron: "ah-SEP-tan tar-HEH-tah",                             en: "Do you accept card?" } },
      { es: "el cambio",         display: "cambio",         pron: "el KAM-byoh",              en: "change",          phrase: { es: "¿Me puede dar mi cambio, por favor?",         pron: "meh PWEH-deh dar mee KAM-byoh por fah-VOR",          en: "Can you give me my change, please?" } },
    ],
  },
  {
    ...
    words: [
      { es: "la parada",      display: "parada",      pron: "lah pah-RAH-dah",       en: "bus stop",      phrase: { es: "¿Dónde está la parada del autobús ADO?",           pron: "DON-deh es-TAH lah pah-RAH-dah del ow-toh-BOOS ah-deh-OH",    en: "Where is the ADO bus stop?" } },
      { es: "el autobús",     display: "autobús",     pron: "el ow-toh-BOOS",        en: "bus",           phrase: { es: "¿Cuál autobús va a Cancún?",                       pron: "kwal ow-toh-BOOS bah ah kan-KOON",                             en: "Which bus goes to Cancún?" } },
      { es: "el boleto",      display: "boleto",      pron: "el boh-LEH-toh",        en: "ticket",        phrase: { es: "Aquí está mi boleto.",                             pron: "ah-KEE es-TAH mee boh-LEH-toh",                                en: "Here is my ticket." } },
      { es: "el asiento",     display: "asiento",     pron: "el ah-SYEN-toh",        en: "seat",          phrase: { es: "Disculpe, ese es mi asiento. Tengo el ocho.",      pron: "dees-KUL-peh EH-seh ehs mee ah-SYEN-toh TEN-goh el OH-choh",  en: "Excuse me, that is my seat. I have number eight." } },
      { es: "el taxi",        display: "taxi",        pron: "el TAK-see",            en: "taxi",          phrase: { es: "¿Dónde puedo tomar un taxi?",                      pron: "DON-deh PWEH-doh toh-MAR oon TAK-see",                         en: "Where can I get a taxi?" } },
      { es: "la dirección",   display: "dirección",   pron: "lah dee-rek-SYON",      en: "address",       phrase: { es: "Esta es la dirección de mi hotel.",                pron: "ES-tah ehs lah dee-rek-SYON deh mee oh-TEL",                   en: "This is the address of my hotel." } },
      { es: "el precio",      display: "precio",      pron: "el PREH-syoh",          en: "price",         phrase: { es: "¿Cuál es el precio por llevarme al hostal?",       pron: "kwal ehs el PREH-syoh por yeh-BAR-meh al os-TAL",              en: "What is the price to take me to the hostel?" } },
      { es: "la reservación", display: "reservación", pron: "lah reh-ser-bah-SYON",  en: "reservation",   phrase: { es: "Buen día, tengo una reservación a nombre de...",   pron: "bwen DEE-ah TEN-goh OO-nah reh-ser-bah-SYON ah NOM-breh deh", en: "Good day, I have a reservation under the name of..." } },
    ],
  },
  {
