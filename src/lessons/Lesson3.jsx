...
// ═══════════════════════════════════════════════════════════════
const BUILDER_DATA = [
  { en: "Where is the ADO bus stop?",                          words: ["¿Dónde","está","la","parada","del","autobús","ADO?"],                distractors: ["boleto","taxi"] },
  { en: "Which bus goes to Cancún?",                           words: ["¿Cuál","autobús","va","a","Cancún?"],                                distractors: ["parada","boleto"] },
  { en: "Here is my ticket.",                                  words: ["Aquí","está","mi","boleto."],                                        distractors: ["asiento","precio"] },
  { en: "Excuse me, that is my seat. I have number eight.",    words: ["Disculpe,","ese","es","mi","asiento.","Tengo","el","ocho."],         distractors: ["boleto","taxi"] },
  { en: "Where can I get a taxi?",                             words: ["¿Dónde","puedo","tomar","un","taxi?"],                               distractors: ["dirección","precio"] },
  { en: "This is the address of my hotel.",                    words: ["Esta","es","la","dirección","de","mi","hotel."],                     distractors: ["taxi","reservación"] },
  { en: "What is the price to take me to the hostel?",         words: ["¿Cuál","es","el","precio","por","llevarme","al","hostal?"],         distractors: ["dirección","asiento"] },
  { en: "Good day, I have a reservation under the name of...", words: ["Buen","día,","tengo","una","reservación","a","nombre","de..."],     distractors: ["precio","parada"] },
];
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16, padding: "14px 16px", background: C.turquesaL, borderRadius: 16, border: `1.5px solid ${C.turquesa}20` }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: C.turquesaD, fontWeight: 700 }}>Getting Around · Phrase {phraseIdx + 1} of {BUILDER_DATA.length}</div>
        </div>
      </div>
      <div style={{ height: 4, background: C.grisB, borderRadius: 2, overflow: "hidden", marginBottom: 20 }}>
